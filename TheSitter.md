...
- **Place**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=160, y=160), *Dimensões:* (largura=100, altura=40)

- **Agenda**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=160, y=260), *Dimensões:* (largura=100, altura=40)

- **Sitter**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=160, y=360), *Dimensões:* (largura=100, altura=40)

- **Booking**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=320, y=200), *Dimensões:* (largura=100, altura=40)

- **Booking Status**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=320, y=260), *Dimensões:* (largura=100, altura=40)

- **Status**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=320, y=320), *Dimensões:* (largura=100, altura=40)

- **Client**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=480, y=160), *Dimensões:* (largura=100, altura=40)

- **Client Family**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=480, y=260), *Dimensões:* (largura=100, altura=40)

- **Family Member**
  - *Estilo:* `shape=ext;margin=3;double=1;whiteSpace=wrap;html=1;align=center;`
  - *Posição:* (x=480, y=360), *Dimensões:* (largura=100, altura=40)

- **Conexões**
  - 1. Source: **Booking**, Target: **Agenda**
  - 2. Source: **Booking Status**, Target: **Status**
  - 3. Source: **Booking**, Target: **Client**
  - 4. Source: **Booking**, Target: **Family Member**
  - 5. Source: **Status**, Target: **Client Family**
  - 6. Source: **Family Member**, Target: **Sitter**
  - 7. Source: **Family Member**, Target: **Client**
  - 8. Source: **Family Member**, Target: **Family Member**
